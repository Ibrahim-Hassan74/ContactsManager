...
namespace CRUDExample.Filters.ExceptionsFilter
{
    public class HandleExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            if (_hostEnvironment.IsDevelopment())
                ...
                context.Result = new ContentResult() { Content = "<h1>An error occurred. Please try again later.</h1>", StatusCode = 500, ContentType = "text/html" };
        }
    }
}
